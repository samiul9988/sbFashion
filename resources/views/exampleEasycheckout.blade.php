        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                {{-- <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="transaction_id" name="transaction_id">
                    <label class="custom-control-label" for="same-address">Transtion_id</label>
                </div> --}}
